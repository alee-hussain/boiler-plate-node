...
const UserService = require("@v1_services/user_service");
...
class UserController {
  ...
  reset_password = async (req, res, next) => {
    try {
      ...
      const response = ok_response(null, "Password Reset Successfully");
      return res.status(response.status.code).json(response);
    } catch (error) {
      next(error);
    }
  ...
  delete_user = async (req, res, next) => {
    try {
      ...
      const response = ok_response(null, `User deleted successfully.`);
      return res.status(response.status.code).json(response);
    } catch (error) {
      next(error);
    }
  ...
  logout_user = async (req, res, next) => {
    try {
      ...
      const response = ok_response(null, "User logout successful.");
      return res.status(response.status.code).json(response);
    } catch (error) {
      next(error);
    }
  ...
  get_me = async (req, res, next) => {
    try {
      ...
      const response = ok_response(db_user, "User Data");
      return res.status(response.status.code).json(response);
    } catch (error) {
      next(error);
    }
  ...
  edit_me = async (req, res, next) => {
    try {
      ...
      const response = ok_response(null, "Your profile updated successfully.");
      return res.status(response.status.code).json(response);
    } catch (error) {
      next(error);
    }
  ...
  create_profile = async (req, res, next) => {
    try {
      ...
      const response = ok_response(null, "Your profile created successfully.");
      return res.status(response.status.code).json(response);
    } catch (error) {
      next(error);
    }
  ...
  get_all_users = async (req, res) => {
    try {
      ...
      const response = ok_response(users, "All users.");
      return res.status(response.status.code).json(response);
    } catch (error) {
      next(error);
    }
